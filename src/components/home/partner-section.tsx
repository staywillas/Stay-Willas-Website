...
const PartnerSection = () => {
  return (
    <section className="py-10 sm:py-16 md:py-24 px-4 sm:px-8 md:px-12 lg:px-24 bg-gradient-to-br from-[#4A5D23] via-[#559C24] to-[#2E3C14] overflow-hidden relative">
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-5">
            {benefits.map((benefit, index) => (
              ...
              >
                <div className="w-8 h-8 sm:w-12 sm:h-12 rounded-full bg-[#559C24]/10 flex items-center justify-center mb-1.5 sm:mb-4 text-[#559C24] transition-colors shrink-0">
                  <benefit.icon size={16} className="group-hover:scale-110 transition-transform sm:hidden" />
                  <benefit.icon size={24} className="group-hover:scale-110 transition-transform hidden sm:block" />
                </div>
            ...
            >
              <div className="flex items-center gap-2 sm:gap-3.5">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-[#559C24]/10 flex items-center justify-center text-[#559C24] shrink-0">
                  <Shield className="text-[#559C24] sm:hidden" size={16} />
                  <Shield className="text-[#559C24] hidden sm:block" size={20} />
                </div>
                <div className="text-left">
                  <h4 className="text-[#1B3564] font-black tracking-wide text-[11px] sm:text-sm leading-tight">Trusted by Owners</h4>
                  <p className="text-[#1B3564]/70 text-[8.5px] sm:text-xs font-semibold mt-0.5 leading-tight">Join our premium hospitality network.</p>
                </div>
              </div>
