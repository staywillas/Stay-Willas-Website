        ...
        <div className="mb-20 text-left">
          ...
          <div className="space-y-8 text-slate-800 text-sm sm:text-base leading-relaxed font-light font-sans select-text">
            ...
            <div className="space-y-4">
              ...
              <p>
                Leaving pets behind when going on vacation is a common challenge for pet owners. That is why many of our properties are designed to be pet-friendly. Sprawling, fully fenced lawns allow your dogs to run around and explore safely. Our staff is trained to be welcoming to pets, ensuring a stress-free experience for the entire family. Having your pets join you by the pool adds an extra layer of joy to your weekend getaway at our <strong className="text-[#1B3564]">villas in lonavala</strong>, making it the perfect choice among <strong className="text-[#1B3564]">private pool villas near mumbai</strong>. Furthermore, when staying at our <strong className="text-[#1B3564]">luxury villas in khopoli</strong> or Lonavala, we encourage our guests to respect the local environment and community guidelines. From minimizing single-use plastics to conserving water and electricity, small actions contribute to sustainable tourism. Our local estate managers are recruited from nearby villages, supporting the local economy and providing authentic hospitality. We invite you to experience our <strong className="text-[#1B3564]">luxury villas in khopoli</strong> for a fully immersive nature getaway.
              </p>
            </div>
