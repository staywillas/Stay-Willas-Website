          ...
          <div className="md:col-span-4">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <a href="tel:+919619042310" className="text-white/50 hover:text-gold transition-colors text-sm">+91 96190 42310</a>
              </div>
              <div className="flex items-center gap-4">
                <svg 
                ...
                <a href="https://wa.me/919619042310" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-[#25D366] transition-colors text-sm">
                  WhatsApp Chat
                </a>
              </div>
              <div className="flex items-center gap-4">
