...
export const metadata: Metadata = {
  title: "About Us | Stay Willas | The Gold Standard of Hospitality",
  ...
  return (
    <main className="min-h-screen bg-charcoal text-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            <h1 className="text-5xl md:text-8xl font-heading mb-8 leading-tight">
              What Luxury <br />
              <span className="italic text-gold text-gradient">Really Means.</span>
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            {[
              ...
              <div key={pillar.title} className="text-center group">
                <div className="w-16 h-16 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center mx-auto mb-6 group-hover:bg-gold group-hover:text-charcoal transition-all">
                  <pillar.icon size={32} />
                </div>
      ...
      <section className="py-32 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto">
        <div className="bg-white/5 rounded-[40px] p-12 md:p-24 border border-white/10 text-center relative overflow-hidden">
          ...
          <div className="flex items-center justify-center gap-4">
            <div className="w-12 h-12 rounded-full bg-gold/20 flex items-center justify-center">
              <span className="text-gold font-bold italic font-heading">W</span>
            </div>
            <div className="text-left">
              <p className="font-bold tracking-widest text-xs uppercase">The Stay Willas Team</p>
              <p className="text-white/40 text-[10px] uppercase tracking-widest">Curation Specialists</p>
            </div>
          </div>
        </div>
      </section>
